...
public class UsuarioController {
    ...
    {
        logRequest("GET /usuario", "search=" + search);
    ...
    {
        logRequest("GET /usuario/enabled", "search=" + search);
    ...
    public ResponseEntity<?> save(
            @RequestBody(required = false) @Valid UsuarioDTO dto,
            @RequestHeader(name = "Authorization", defaultValue = "") String accessToken,
            @RequestHeader(name = "Requestor", defaultValue = "") String requestor
    )
    {
        logRequest("POST /usuario", dto.toString());
    ...
    public ResponseEntity<?> update(
        ...
        logRequest("PUT /usuario/{id}", dto.toString());
    ...
    public ResponseEntity<?> delete(
        ...
        logRequest("DELETE /usuario/{id}",id.toString());
    ...
    public ResponseEntity<?> enable(
        ...
        logRequest("PUT /usuario/{id}/enable",id.toString());
    ...
    public ResponseEntity<?> disable(
        ...
        logRequest("PUT /usuario/{id}/disable",id.toString());
    ...
    public ResponseEntity<?> getByNombre(
        ...
        logRequest("GET /usuario/{nombre}/by-nombre",nombre);
    ...
    public ResponseEntity<?> search(
        ...
        logRequest("GET /usuario/search", "nombre=" + nombre + ", email=" + email);

        try {
            return logAndRespond(HttpStatus.OK, service.search(nombre, email, pageable));
        } catch (BaseException e) {
            return logAndRespond(HttpStatus.UNPROCESSABLE_ENTITY, e.getErrors());
        } catch (Exception e) {
            return logAndRespond(HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage());
